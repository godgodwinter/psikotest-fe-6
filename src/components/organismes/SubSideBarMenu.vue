...
<template>
  <div>
    ...
    <div class="bg-base-100 p-3 border-t-4 border-green-400">
      ...
      <p class="text-sm text-base-content font-bold text-lg hover:text-gray-600 leading-6 text-center pt-2">
        {{ data.nama }}
      </p>
      <ul
          ...
          <span class="ml-auto">
            <div class="flex justify-center">
              <div class="form-check form-switch">
                <button class="btn btn-sm text-xs btn-base" :class="{ 'btn-success ': status }"
    ...
    <div class="bg-base-100 p-3 hover:shadow">
      ...
      <div class="px-6">
        <ul class="space-y-2 pb-2 lg:flex flex-wrap px-2 gap-0 justify-between">
          <li class="bg-base-100 lg:w-full py-2" :class="[subMenuActive == 'dashboard' ? pagesActiveClass : '']">
            <router-link :to="{ name: 'AdminSekolahDetailDashboard', params: { id } }"
          ...
          <li class="bg-base-100 lg:w-full py-0" :class="[subMenuActive == 'kelas' ? pagesActiveClass : '']">
            <router-link :to="{ name: 'AdminSekolahDetailKelas', params: { id } }"
              class="text-base-content font-normal rounded-lg flex items-center p-2 group hover:link">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
          ...
          <li class="bg-base-100 lg:w-full py-0" :class="[subMenuActive == 'walikelas' ? pagesActiveClass : '']">
            <router-link :to="{ name: 'AdminSekolahDetailWalikelas', params: { id } }"
              class="text-base-content font-normal rounded-lg flex items-center p-2 group hover:link">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
          ...
          <li class="bg-base-100 lg:w-full py-0" :class="[subMenuActive == 'bk' ? pagesActiveClass : '']">
            <router-link :to="{ name: 'AdminSekolahDetailBk', params: { id } }"
              class="text-base-content font-normal rounded-lg flex items-center p-2 group hover:link">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                <path d="M4 4a2 2 0 00-2 2v1h16V6a2 2 0 00-2-2H4z" />
                <path fill-rule="evenodd"
          ...
          <li class="bg-base-100 lg:w-full py-0" :class="[subMenuActive == 'pengguna' ? pagesActiveClass : '']">
            <router-link :to="{ name: 'AdminSekolahDetailPengguna', params: { id } }"
              class="text-base-content font-normal rounded-lg flex items-center p-2 group hover:link">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                <path fill-rule="evenodd"
      ...
      <div>
        <div class="flex items-center space-x-3 font-semibold text-base-content text-xl leading-8 pt-2">
          <span class="text-green-500">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
              <path fill-rule="evenodd"
  ...
  params: { id, kelas_id },
            ...
            <li class="bg-base-100 lg:w-full py-0" :class="[subMenuActive == 'hasil_ujian' ? pagesActiveClass : '']">
              <router-link :to="{ name: 'AdminSekolahDetail.hasil_ujian', params: { id, kelas_id } }"
                ...
                <span class="ml-3">Hasil Ujian Minat Bidang Studi</span>
              </router-link>
            </li>
            <li class="bg-base-100 lg:w-full py-0" :class="[subMenuActive == 'kasus' ? pagesActiveClass : '']">
              <router-link :to="{ name: 'AdminSekolahDetailKasus', params: { id } }"
                class="text-base-content font-normal rounded-lg flex items-center p-2 group hover:link">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                  stroke="currentColor" stroke-width="2">
                  <path stroke-linecap="round" stroke-linejoin="round"
  ...
  params: { id },
            ...
            <li class="bg-base-100 lg:w-full py-0" :class="[subMenuActive == 'prestasi' ? pagesActiveClass : '']">
              <router-link :to="{ name: 'AdminSekolahDetailPrestasi', params: { id } }"
                class="text-base-content font-normal rounded-lg flex items-center p-2 group hover:link">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                  <path
