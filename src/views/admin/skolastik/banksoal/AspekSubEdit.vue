...
const aspek_sub_id = route.params.aspek_sub_id;
...
const getDataDetail = async () => {
    try {
        const response = await Api.get(`admin/ujian/skolastik/aspek/null/detail/${aspek_sub_id}`);
...
const onSubmit = async (values) => {
    ...
    try {
        const response = await Api.put(
            `admin/ujian/skolastik/aspek/${aspek_id}/detail/${aspek_sub_id}`,
            inputForm
        );
        // console.log(response);
