...
<template>
    ...
    <div class="py-4 px-4 ">
        <article class="prose lg:prose-md prose-stone max-w-none">
            ...
            <p>Anda saat ini memiliki perkembangan karakter positif rata-rata tergolong :
                86 Sangat Tinggi Sekali, (Aktivitas usaha Anda saat ini kecenderungan sangat besar sekali dipengaruhi
            ...
            <p>
                Bila nilai karakter positif Anda sangat tinggi akan membantu dalam mendukung kesuksesan dan peningkatan
                prestasi usaha aktivitas Anda, terutama Anda harus memperhatikan potensi kualitas diri yang dikuatkan
                oleh
                aspek karakter positif yang menjadi tolak ukur Anda sukses. Nilai yang perlu Anda perhatikan antara
                batas
                Cukup sampai Sangat Tinggi Sekalai. Upayakan dalam setiap hari adanya perhatian dan peningkatan kualitas
                pribadi positif Anda melalui penerapan secara nyata melalui kegiatan sehari-hari dengan memanfaatkan
                nilai-nilai karakter positif yang menonjol atau kuat pada hari ini dan di ekspresikan secara tepat pada
    ...
    <div class="py-4 px-4 ">
        <article class="prose lg:prose-md prose-stone max-w-none">
            ...
            <p>Anda saat ini memiliki ganguan perkembangan karakter negatif rata-rata tergolong ; 55 Rendah,(Aktivitas
            ...
            <p>Bila nilai karakter negatif Anda sangat tinggi akan mengganggu atau merugikan saat Anda melakukan usaha
                ...
                kesadaran, kuatkan dengan tindakan nyata melalui sikap merenung tentang nilai kehidupan, melakukan sikap
                meditasi dan selalu berdoa, memperkuat penyerahan diri dan memperbanyak nilai ke ikhlasan, nilai syukur,
                nilai pengampunan. Lakukan dalam setiap hari secara rutin,terarah dalam tujuan dan dilakukan perubahan
