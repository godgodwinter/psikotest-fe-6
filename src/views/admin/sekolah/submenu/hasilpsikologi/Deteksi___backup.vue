...
<template>
    ...
    <div v-if="siswa">
        ...
        <div class="pt-4 px-10 md:flex justify-between">
            <div>
                <span class="text-2xl sm:text-xl leading-none font-bold text-gray-600 shadow-sm">II. EQ (Emotional
                    Quotient):
        ...
        <div class="pt-4 px-10 md:flex justify-between">
            <div>
                <span class="text-2xl sm:text-xl leading-none font-bold text-gray-600 shadow-sm">Saat ini anda memiliki
                    Gangguan Karakter :{{
